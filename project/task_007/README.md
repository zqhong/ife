<main class="container task-detail-page"><div class="breadcrumb nav-title"><span class="active">任务七：实现常见的技术产品官网的页面架构及样式布局</span></div><div class="main container-fluid"><div class="row task-detail-wrap"><div class="task-detail col-md-9"><div><dl>
	<dt>面向人群：</dt>
	<dd>初学者</dd>
	<dt>难度：</dt>
	<dd>简单</dd>
